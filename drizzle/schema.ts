...
export const masterdataInPplFirst = pplFirst.table(
  "masterdata",
  {
    ...
    createddatetime: timestamp({ precision: 6, mode: "string" })
...
export const companyMasterdataMapInPplFirst = pplFirst.table(
  "company_masterdata_map",
  {
...
export const certificationProvidersInPplFirst = pplFirst.table(
  ...
  (table) => [
    uniqueIndex("ux_cert_providers_tenant_name").using(
      "btree",
...
export const contentInPplFirst = pplFirst.table(
  "content",
  {
    ...
    isactive: boolean().default(true).notNull(),
    createddatetime: timestamp({ precision: 3, mode: "string" })
      .default(sql`CURRENT_TIMESTAMP`)
      .notNull(),
...
export const companyMasterdataHierarchyInPplFirst = pplFirst.table(
  "company_masterdata_hierarchy",
  {
  ...
  (table) => [
    ...
    foreignKey({
      ...
      .onUpdate("cascade")
      .onDelete("restrict"),
    unique("uq_cmh_company_masterdata_tenant").on(
      table.companyId,
      table.masterdataId,
      table.parentMasterdataId,
      table.tenant,
    ),
  ],
);

export const datagroupInPplFirst = pplFirst.table(
  "datagroup",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    name: text().notNull(),
...
export const datagrouphierarchyInPplFirst = pplFirst.table(
  "datagrouphierarchy",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    code: text().notNull(),
...
export const certificationsInPplFirst = pplFirst.table(
  "certifications",
  {
  ...
  (table) => [
    uniqueIndex("ux_certs_tenant_provider_name").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
      table.providerId.asc().nullsLast().op("uuid_ops"),
      table.certificationName.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.createdtenant],
      foreignColumns: [tenantInPplFirst.id],
...
export const companyAgencyMapInPplFirst = pplFirst.table(
  "company_agency_map",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    companyId: uuid("company_id").notNull(),
...
export const modulemasterInPplFirst = pplFirst.table(
  "modulemaster",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    name: text().notNull(),
...
export const notificationsInPplFirst = pplFirst.table(
  "notifications",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    tenantId: uuid("tenant_id").notNull(),
...
export const agencyMasterInPplFirst = pplFirst.table(
  "agency_master",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
  ...
  (table) => [unique("agency_master_agency_code_key").on(table.agencyCode)],
);

export const companyMasterInPplFirst = pplFirst.table(
  "company_master",
  {
  ...
  (table) => [
    uniqueIndex("ux_company_master_tenant_code").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
      table.companyCode.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("ux_company_master_tenant_name").using(
      "btree",
      table.tenantId.asc().nullsLast().op("text_ops"),
...
export const masterdatahierarchyInPplFirst = pplFirst.table(
  "masterdatahierarchy",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    code: text().notNull(),
...
export const policyInPplFirst = pplFirst.table(
  "policy",
  {
...
export const rolepermissionInPplFirst = pplFirst.table(
  "rolepermission",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    tenant: uuid().notNull(),
...
export const onboardingReferencesInPplFirst = pplFirst.table(
...
export const permissionInPplFirst = pplFirst.table(
  "permission",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    tenant: uuid().notNull(),
  ...
  (table) => [
    uniqueIndex("permission_code_unique1").using(
      "btree",
      table.tenant.asc().nullsLast().op("text_ops"),
      table.code.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("uq_permission_tenant_code").using(
      "btree",
      table.tenant.asc().nullsLast().op("text_ops"),
...
export const subscriptionmasterInPplFirst = pplFirst.table(
  "subscriptionmaster",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    name: text().notNull(),
...
export const subscriptionpricingInPplFirst = pplFirst.table(
  "subscriptionpricing",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    type: text().notNull(),
...
export const supportTicketAttachmentInPplFirst = pplFirst.table(
...
export const submodulemasterInPplFirst = pplFirst.table(
  "submodulemaster",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    name: text().notNull(),
...
export const supportTicketInPplFirst = pplFirst.table(
  "support_ticket",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    tenant: uuid().notNull(),
...
export const subscriptiondetailsInPplFirst = pplFirst.table(
  "subscriptiondetails",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    isactive: boolean().default(true).notNull(),
...
export const surveyInPplFirst = pplFirst.table(
  "survey",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    tenantId: uuid("tenant_id").notNull(),
...
export const surveyConditionalQuestionInPplFirst = pplFirst.table(
...
export const surveyQuestionInPplFirst = pplFirst.table(
  "survey_question",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const surveyLinkedEntityInPplFirst = pplFirst.table(
  "survey_linked_entity",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const surveySectionInPplFirst = pplFirst.table(
  "survey_section",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    surveyId: uuid("survey_id").notNull(),
...
export const surveyInstanceInPplFirst = pplFirst.table(
  "survey_instance",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    surveyId: uuid("survey_id").notNull(),
...
export const surveyOptionInPplFirst = pplFirst.table(
  "survey_option",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const surveyUserInPplFirst = pplFirst.table(
  "survey_user",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    surveyId: uuid("survey_id").notNull(),
...
export const surveyResponseInPplFirst = pplFirst.table(
  "survey_response",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const supportTicketCommentInPplFirst = pplFirst.table(
...
export const supportTicketSlaInPplFirst = pplFirst.table(
  "support_ticket_sla",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const supportTicketStatusHistoryInPplFirst = pplFirst.table(
  "support_ticket_status_history",
  {
    ...
    changedAt: timestamp("changed_at", { precision: 6, mode: "string" })
      .default(sql`CURRENT_TIMESTAMP`)
      .notNull(),
    isactive: boolean().default(true).notNull(),
    createddatetime: timestamp({ precision: 6, mode: "string" })
...
export const tenantpaymentInPplFirst = pplFirst.table(
  "tenantpayment",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const tenantInPplFirst = pplFirst.table(
  "tenant",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    name: text().notNull(),
...
export const tenantcontactInPplFirst = pplFirst.table(
  "tenantcontact",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    tenant: uuid().notNull(),
...
export const tenantsubscriptionpricingInPplFirst = pplFirst.table(
...
export const userInPplFirst = pplFirst.table(
  "user",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    name: text(),
...
export const userOnboardingInPplFirst = pplFirst.table(
  "user_onboarding",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    tenant: uuid().notNull(),
...
export const userLanguageInPplFirst = pplFirst.table(
  "user_language",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const userbankingInPplFirst = pplFirst.table(
  "userbanking",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const userOnboardingAssignmentInPplFirst = pplFirst.table(
...
export const userOnboardingDocumentInPplFirst = pplFirst.table(
  "user_onboarding_document",
  {
    id: text().primaryKey().notNull(),
    onboardingId: uuid("onboarding_id").notNull(),
...
export const userBgvAssignmentInPplFirst = pplFirst.table(
  "user_bgv_assignment",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    userId: uuid("user_id").notNull(),
...
export const usercontactInPplFirst = pplFirst.table(
  "usercontact",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    usermaster: uuid().notNull(),
  ...
  (table) => [
    uniqueIndex("uk_ucontact").using(
      "btree",
      table.value.asc().nullsLast().op("uuid_ops"),
      table.tenant.asc().nullsLast().op("text_ops"),
      table.usermaster.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
...
export const usercontentInPplFirst = pplFirst.table(
  "usercontent",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    content: text().notNull(),
  ...
  (table) => [
    uniqueIndex("usercontent_content_usermaster_key").using(
      "btree",
...
export const userCertificationsInPplFirst = pplFirst.table(
  "user_certifications",
  {
  ...
  (table) => [
    uniqueIndex("ux_user_certs_tenant_user_cert").using(
      "btree",
      table.tenantId.asc().nullsLast().op("uuid_ops"),
      table.userId.asc().nullsLast().op("uuid_ops"),
      table.certificationId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const userdocumentInPplFirst = pplFirst.table(
  "userdocument",
  {
    id: text().primaryKey().notNull(),
    documenttype: text().notNull(),
...
export const usereducationInPplFirst = pplFirst.table(
  "usereducation",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const usereducationDocumentInPplFirst = pplFirst.table(
  "usereducation_document",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const userexperienceInPplFirst = pplFirst.table(
  "userexperience",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const useraddressInPplFirst = pplFirst.table(
  "useraddress",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    usermaster: uuid().notNull(),
...
export const userDirectorshipInPplFirst = pplFirst.table(
  "user_directorship",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    userId: uuid("user_id").notNull(),
...
export const userimmigrationInPplFirst = pplFirst.table(
  "userimmigration",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const userlogInPplFirst = pplFirst.table(
  "userlog",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    usermaster: uuid(),
...
export const userskillInPplFirst = pplFirst.table(
  "userskill",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    domain: text().notNull(),
...
export const userprofileDojHistoryInPplFirst = pplFirst.table(
  "userprofile_doj_history",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    tenant: uuid().notNull(),
    companyId: uuid("company_id").notNull(),
...
export const userrolemapInPplFirst = pplFirst.table(
  "userrolemap",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    usermaster: uuid().notNull(),
  ...
  (table) => [
    uniqueIndex("uk_usermaster_role").using(
      "btree",
      table.usermaster.asc().nullsLast().op("text_ops"),
...
export const userprofileInPplFirst = pplFirst.table(
  "userprofile",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    usermaster: uuid().notNull(),
...
export const userexperienceDocumentInPplFirst = pplFirst.table(
  "userexperience_document",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const userskilltoolInPplFirst = pplFirst.table(
  "userskilltool",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    tool: text().notNull(),
...
export const userworkpreferenceInPplFirst = pplFirst.table(
  "userworkpreference",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const userfeedbackInPplFirst = pplFirst.table(
  "userfeedback",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    training: text(),
...
export const agencyServiceMapInPplFirst = pplFirst.table(
  "agency_service_map",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    agencyMasterId: uuid("agency_master_id").notNull(),
...
export const usermasterInPplFirst = pplFirst.table(
  "usermaster",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    login: text().notNull(),
...
export const roleInPplFirst = pplFirst.table(
  "role",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    name: text().notNull(),
...
export const tenantsubscriptionInPplFirst = pplFirst.table(
  "tenantsubscription",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const userAgencyMapInPplFirst = pplFirst.table(
  "user_agency_map",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    userId: uuid("user_id").notNull(),
