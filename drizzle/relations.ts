...
import {
  datagroupInPplFirst,
  masterdataInPplFirst,
  tenantInPplFirst,
  usermasterInPplFirst,
  companyMasterInPplFirst,
  companyMasterdataMapInPplFirst,
  certificationProvidersInPplFirst,
  contentInPplFirst,
  companyMasterdataHierarchyInPplFirst,
  datagrouphierarchyInPplFirst,
  certificationsInPplFirst,
  agencyMasterInPplFirst,
  companyAgencyMapInPplFirst,
  modulemasterInPplFirst,
  notificationsInPplFirst,
  masterdatahierarchyInPplFirst,
  policyInPplFirst,
  roleInPplFirst,
  rolepermissionInPplFirst,
  onboardingReferencesInPplFirst,
  userOnboardingInPplFirst,
  permissionInPplFirst,
  subscriptionmasterInPplFirst,
  subscriptionpricingInPplFirst,
  submodulemasterInPplFirst,
  supportTicketInPplFirst,
  supportTicketAttachmentInPplFirst,
  subscriptiondetailsInPplFirst,
  surveyInPplFirst,
  surveyConditionalQuestionInPplFirst,
  surveyQuestionInPplFirst,
  surveyOptionInPplFirst,
  surveySectionInPplFirst,
  surveyLinkedEntityInPplFirst,
  surveyInstanceInPplFirst,
  surveyUserInPplFirst,
  surveyResponseInPplFirst,
  supportTicketCommentInPplFirst,
  supportTicketSlaInPplFirst,
  supportTicketStatusHistoryInPplFirst,
  tenantpaymentInPplFirst,
  tenantsubscriptionInPplFirst,
  tenantcontactInPplFirst,
  tenantsubscriptionpricingInPplFirst,
  userInPplFirst,
  userLanguageInPplFirst,
  userbankingInPplFirst,
  userOnboardingAssignmentInPplFirst,
  userOnboardingDocumentInPplFirst,
  userBgvAssignmentInPplFirst,
  usercontactInPplFirst,
  usercontentInPplFirst,
  userCertificationsInPplFirst,
  userdocumentInPplFirst,
  usereducationInPplFirst,
  usereducationDocumentInPplFirst,
  userexperienceInPplFirst,
  useraddressInPplFirst,
  userDirectorshipInPplFirst,
  userimmigrationInPplFirst,
  userlogInPplFirst,
  userskillInPplFirst,
  userprofileDojHistoryInPplFirst,
  userprofileInPplFirst,
  userrolemapInPplFirst,
  userexperienceDocumentInPplFirst,
  userskilltoolInPplFirst,
  userworkpreferenceInPplFirst,
  userfeedbackInPplFirst,
  agencyServiceMapInPplFirst,
  userAgencyMapInPplFirst,
} from "./schema";
...
export const certificationProvidersInPplFirstRelations = relations(
  certificationProvidersInPplFirst,
  ({ one, many }) => ({
    tenantInPplFirst_createdtenant: one(tenantInPplFirst, {
...
export const companyMasterdataHierarchyInPplFirstRelations = relations(
  companyMasterdataHierarchyInPplFirst,
  ({ one }) => ({
    companyMasterInPplFirst: one(companyMasterInPplFirst, {
...
export const surveyConditionalQuestionInPplFirstRelations = relations(
  surveyConditionalQuestionInPplFirst,
  ({ one }) => ({
    companyMasterInPplFirst: one(companyMasterInPplFirst, {
...
export const supportTicketStatusHistoryInPplFirstRelations = relations(
  supportTicketStatusHistoryInPplFirst,
  ({ one }) => ({
...
export const tenantsubscriptionpricingInPplFirstRelations = relations(
  tenantsubscriptionpricingInPplFirst,
  ({ one }) => ({
    tenantInPplFirst_createdtenant: one(tenantInPplFirst, {
